...
When a UI reference conflicts with a documented product decision, `PRODUCT-DECISIONS.md` and the relevant product specification remain the source of truth. The UI references should guide visual hierarchy, interaction feel, density, whitespace, and presentation choices.
